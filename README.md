...
Now clone the forked repository to your machine. Go to your GitHub account, open the forked repository, click the **Code** button, select the **SSH** tab, then click the **copy to clipboard** icon to copy the repository URL.
